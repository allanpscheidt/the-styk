...
在 https://setor101.com.br/apps 下载 The Styk，将其拖入您的“应用程序”（Applications）文件夹，然后双击图标启动它。
...
### 它支持 macOS 10.x 吗？
主要的 Apple Silicon 版本需要 macOS 11 (Big Sur) 或更高版本。但是，也提供了一个兼容 macOS 10.13 (High Sierra) 及更高版本的 Intel 遗留版本。
